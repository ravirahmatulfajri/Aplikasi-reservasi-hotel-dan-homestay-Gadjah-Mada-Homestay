                    ...
                    <div class="col-lg-3 offset-lg-1">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                ...
                                <td height="25" class="blue">Tgl Chek In :</td><br> <td class="blue"><b><?php echo"$tgl_ci" ?></b>
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <!-- <h3>support@colorlib.com</h3> -->
                                <td height="25" class="blue">Tgl Cek Out :</td><br><td class="blue"><b><?php echo"$tgl_co" ?></b>
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <!-- <h3>support@colorlib.com</h3> -->
                                <td height="25" class="blue">Tipe :</td><br><td class="blue"><b><?php echo"$tipe_kamar" ?></b>
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <!-- <h3>support@colorlib.com</h3> -->
                                <td height="25" class="blue">Location :</td><br><td class="blue"><b><?php echo"$location" ?></b>
                                <input name="location" type="hidden" value="<?php echo"$location" ?>"></td>
                            </div>
                        </div>
                    </div>
                </div>
