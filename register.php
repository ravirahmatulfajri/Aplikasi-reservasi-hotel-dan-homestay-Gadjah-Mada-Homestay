            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="col-lg-8 mb-5 mb-lg-0">
                        <article class="blog_item container-fluid">

                            <div class="blog_item_img">
                                <img class="card-img rounded-0" alt="">
                                <a href='index.php?menu=reservations&id=<?= $id_tipe ?>'>
                                    <img src="<?= $pict ?>" width='100%' height='auto' style="object-fit: cover;" />
                                </a>
                            </div>
                            ...
                            <div class="py-5">
                                ...
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?= "REC-$no_pesan" ?></b>
                                            <input name="no_pesan" type="hidden" value="<?= "REC-$no_pesan" ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <?= "$tgl_ci" ?>
                                            <input name="tgl_cci" type="hidden" value="<?= "$tgl_cci" ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <?= "$tgl_co" ?>
                                            <input name="tgl_cco" type="hidden" value="<?= "$tgl_cco" ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Tipe Kamar</th>
                                        <td>
                                            <?= "$tipe_kamar" ?>
                                            <input name="id_tipe" type="hidden" value="<?= "$id_tipe" ?>">
                                        </td>
                                    </tr>
                            ...
                            <td class='blue'>
                                ...
                                while ($data1 = mysqli_fetch_array($qr1)) {
                                    ...
                                    if ($status <> 'use') :
                                        ...
                                        if ($ada_apa_enggak >= 1) :
                                            echo "<input type='checkbox' style='margin: 0.5rem;' name='kamar_in_user' checked='checked' disabled='disabled' />Kamar  $nm_kamar (status = <span class='red'>use/booking</span>)<br />";
                                        else :
                                            echo "<input type='checkbox' style='margin: 0.5rem;' name='required_id_kamar[]' id='required_id_kamar' value='$id_kamar' />Kamar $nm_kamar (status = <span class='green'>kosong</span>)<br />";
                                        endif;
                                    else :
                                        echo "<input type='checkbox' style='margin: 0.5rem;' name='kamar_in_user' checked='checked' disabled='disabled' />Kamar No $nm_kamar (status = <span class='red'>use/booking</span>)<br />";
                                    endif;
                                }
                                ?>
                            </td>
